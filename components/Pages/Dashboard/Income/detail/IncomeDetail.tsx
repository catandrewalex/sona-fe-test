...
import IncomeDetailPieChart from "@sonamusica-fe/components/Pages/Dashboard/Income/detail/IncomeDetailPieChart";
...
const IncomeDetail = ({ data, ready }: IncomeDetailProps): JSX.Element => {
  ...
  return (
    <Box>
      ...
      <IncomeDetailPieChart data={data} selected={selectedDate} ready={ready} />
    </Box>
  );
};
